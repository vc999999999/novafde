          ...
          <Fragment key={step.key}>
            <button
              ...
              className={cn(
                ...
                state === 'active'
                  ? 'border-accent-border bg-accent-dim text-foreground shadow-[0_0_24px_rgba(14,124,115,0.22)]'
                  : state === 'done'
                    ? 'border-success-border bg-success-dim text-foreground hover:border-success/40 hover:-translate-y-px'
                    : 'border-black/10 bg-surface text-muted-foreground hover:-translate-y-px hover:border-black/20 hover:text-foreground',
              )}
            >
              <span
                className={cn(
                  ...
                  state === 'active'
                    ? 'bg-accent text-white animate-[pulse-shadow_2.4s_ease-in-out_infinite]'
                    : state === 'done'
            ...
            {i < steps.length - 1 && (
              <div aria-hidden className="relative h-0.5 min-w-3 flex-1 overflow-hidden rounded-full bg-black/8">
                <div
